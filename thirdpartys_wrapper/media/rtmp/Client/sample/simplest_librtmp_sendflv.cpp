...
int publish_using_packet(){
	...
	FILE*fp=NULL;
	fp=fopen("C:\\Users\\2020\\Desktop\\智慧垃圾亭系统设计\\监控\\rtmp\\simplest_librtmp_example\\资源\\cuc_ieschool.flv","rb");
	if (!fp){
	...
	rtmp->Link.timeout=5;			
	if(!RTMP_SetupURL(rtmp,"rtmp://192.168.1.188:1935/live/livestream"))
	{
