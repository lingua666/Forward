#ifndef  __FLV_AVC_DECODER_20170111090004_1444199361_H__
#define  __FLV_AVC_DECODER_20170111090004_1444199361_H__
...
namespace _ffmpeg_{
	...
	class Flv_AVC_Decoder : public IDecoder
	{
	public:
		static	IDecoder* Create( void )
		{
			return reinterpret_cast<IDecoder*>(new Flv_AVC_Decoder());
		}

	public:
		Flv_AVC_Decoder( void );
