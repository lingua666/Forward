...
#ifndef __HASH_STRING_20160418173307_1438860785_H__
#define __HASH_STRING_20160418173307_1438860785_H__
		...
		template<>
		class hash<_string_::string>
			: public unary_function<_string_::string, size_t>
		{	// hash functor
		public:
			typedef _string_::string _Kty;
