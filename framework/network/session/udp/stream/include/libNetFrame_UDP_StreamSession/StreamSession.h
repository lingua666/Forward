...
#ifndef __UDP_STREAMSESSION_20150917152437_2442474677_H__
#define __UDP_STREAMSESSION_20150917152437_2442474677_H__
...
namespace	_session_{
	...
	namespace	_udp_{
		...
		typedef	function20_handle<void (NETHANDLE, sockaddr_in*, const StreamBuf_ptr&)>	Stream_HRecv;
		...
		*/
		...
		public:
			...
			*/
			...
			{
				EVENT_EXEC_READ(this, pSrc, Buf_ptr);
			}
			...
			void	RecvNotify( NETHANDLE Node, sockaddr_in* pSrc, const StreamBuf_ptr& Buf_ptr )
			{
				if( _RecvHandle )
					_RecvHandle(Node, pSrc, Buf_ptr);
			}
			...
			EVENT_PERMISSION_LIST_BEGIN()
				PERMISSION_READ(StreamSession*, sockaddr_in*, const StreamBuf_ptr&)
