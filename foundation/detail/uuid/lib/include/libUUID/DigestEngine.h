...
#ifndef  __CUSTOM_DIGESTENGINE_HEAD_DEF__
#define  __CUSTOM_DIGESTENGINE_HEAD_DEF__
...
public:
	...
	void update(const _string_type& data);
	...
	static _string_type digestToHex(const Digest& bytes);
...
inline void DigestEngine::update(const _string_type& data)
{
...
#endif // __CUSTOM_DIGESTENGINE_HEAD_DEF__
