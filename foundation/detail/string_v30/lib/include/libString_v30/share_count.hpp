...
#ifndef ___STRING_V30_SHARE_COUNT_20160418173307_1438860785_H__
#define ___STRING_V30_SHARE_COUNT_20160418173307_1438860785_H__
...
namespace	_string_v30_ {
	...
	public:
		...
		{
			_pi = sp_counted_impl_p<Allocate>::GetInstance( uSize );
		}

		explicit shared_count( void* pBuf, long BufSize )
		{
			_pi = sp_counted_impl_buf::GetInstance( pBuf, BufSize );
		}
		...
		{
			return _pi != 0 ? _pi->get_buffer_size() : 0;
		}
	};
