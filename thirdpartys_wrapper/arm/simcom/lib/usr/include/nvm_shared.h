...
#ifdef MNV_SUPPORT
#define NVM_OP_CODE_LOAD            10
#define NVM_OP_CODE_SYNC_START      11
#define NVM_OP_CODE_SYNC_DATA       12
#define NVM_OP_CODE_SYNC_END        13
#define NVM_OP_CODE_MAX_COMMAND     14
#else
...
{
	NVM_OP_CODE op_code;
}NVM_LOAD_REQUEST_STRUCT;

typedef struct
{
	NVM_OP_CODE	op_code;
	NVM_STATUS_T error_code;
}NVM_LOAD_RESPONSE_STRUCT;

typedef struct
{
	NVM_OP_CODE op_code;
}NVM_SYNC_START_REQUEST_STRUCT;

typedef struct
{
	NVM_OP_CODE	op_code;
	NVM_STATUS_T error_code;
}NVM_SYNC_START_RESPONSE_STRUCT;
...
typedef struct
{
	...
	UINT32 buffer_len;
	UINT8 buffer[0];
}NVM_SYNC_DATA_REQUEST_STRUCT;

typedef struct
{
	NVM_OP_CODE	op_code;
	NVM_STATUS_T error_code;
}NVM_SYNC_DATA_RESPONSE_STRUCT;

typedef struct
{
	NVM_OP_CODE op_code;
}NVM_SYNC_END_REQUEST_STRUCT;

typedef struct
{
	NVM_OP_CODE	op_code;
	NVM_STATUS_T error_code;
}NVM_SYNC_END_RESPONSE_STRUCT;
#endif
