...
#define USB_CDC_MBIM_EXT_TYPE		0x1c
...
#define USB_CDC_NCM_MIN_HEADER16_SIZE (28)
#define USB_CDC_NCM_MIN_HEADER32_SIZE (48)
...
/* CDC MBIM subclass 9.1: MBIM message header */
struct usb_cdc_mbim_ctrl_msg {
	__le32	dwMessagType;
	__le32	dwMessagLength;
