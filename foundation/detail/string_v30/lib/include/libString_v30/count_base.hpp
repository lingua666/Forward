...
#ifndef __STRING_V30_COUNT_BASE_20160418173307_1438860785_H__
#define __STRING_V30_COUNT_BASE_20160418173307_1438860785_H__
...
#include <stdio.h>
	...
	#define	STRING_OBJ_SIZE_V30			32
#else
	#define	STRING_OBJ_SIZE_V30			24
#endif
...
namespace	_string_v30_{
	...
	public:
		...
		virtual long get_buffer_size(void) const = 0;
