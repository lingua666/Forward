...
#ifndef __COROUTINE_WIN32_20150806193305_1438860785_H__
#define __COROUTINE_WIN32_20150806193305_1438860785_H__
...
comng_t 
co_open(void) {
    struct comng * g = (struct comng *)malloc(sizeof(struct comng));
    g->running = -1;
    g->cs = (struct co **)calloc(COROUTINE_INT, sizeof(struct co *));
    g->cap = COROUTINE_INT;
    g->idx = g->len = 0;
...
co_create(comng_t g, co_f func, void * arg) {
    ...
    // 这里需要重新构建空间
    cs = (struct co **)realloc(cs, sizeof(struct co *) * cap<<1);
