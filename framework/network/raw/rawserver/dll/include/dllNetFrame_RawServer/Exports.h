...
#ifndef __EXPORTS_20160507114441_1451301281_H__
#define __EXPORTS_20160507114441_1451301281_H__
...
/*返回值：
*****************************************************************/
typedef void (_CALLTYPE *pfnRaw_S_Accept)( const char* c_szIP,
											UInt16 uPort,
											NETHANDLE handle );
...
/*返回值：		64bit连接句柄
*****************************************************************/
typedef void (_CALLTYPE *pfnRaw_S_ClientClose)( const char* c_szIP,
											UInt16 uPort,
											NETHANDLE handle );
...
/*返回值：		64bit连接句柄
*****************************************************************/
typedef void (_CALLTYPE *pfnRaw_S_ClientRecData)( NETHANDLE handle,
											const char* c_szData,
											UInt32 u32Size );
