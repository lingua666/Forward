...
#ifndef COPY_BOOST_ASIO_COROUTINE_HPP
#define COPY_BOOST_ASIO_COROUTINE_HPP
...
#define COPY_BOOST_ASIO_CORO_REENTER(c) \
	switch (_coroutine::coroutine_ref _coro_value = c) \
...
#define COPY_BOOST_ASIO_CORO_YIELD_IMPL(n) \
  for (_coro_value = (n);;) \
    if (_coro_value == 0) \
    { \
      case (n): ; \
...
#define COPY_BOOST_ASIO_CORO_FORK_IMPL(n) \
...
#if defined(_MSC_VER)
# define COPY_BOOST_ASIO_CORO_YIELD COPY_BOOST_ASIO_CORO_YIELD_IMPL(__COUNTER__ + 1)
# define COPY_BOOST_ASIO_CORO_FORK COPY_BOOST_ASIO_CORO_FORK_IMPL(__COUNTER__ + 1)
#else // defined(_MSC_VER)
# define COPY_BOOST_ASIO_CORO_YIELD COPY_BOOST_ASIO_CORO_YIELD_IMPL(__LINE__)
# define COPY_BOOST_ASIO_CORO_FORK COPY_BOOST_ASIO_CORO_FORK_IMPL(__LINE__)
