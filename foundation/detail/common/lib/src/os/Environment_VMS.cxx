...
#include <common/platform/CMyException.hpp>
#include <common/platform/Environment_VMS.h>

#define MAXHOSTNAMELEN 64

CLock EnvironmentImpl::_Lock;
...
std::string EnvironmentImpl::getImpl(const std::string& name)
{
	...
	if (val)
		...
		EXCEPTION_THROW(CommonException,"Not Found %s",name)
}
...
int EnvironmentImpl::setImpl(const std::string& name, const std::string& value)
{
	_Lock.Lock();
...
std::string EnvironmentImpl::getsyi(unsigned short code)
{
	...
	if (sys$getsyiw(0, 0, 0, items, 0, 0, 0) == 1)
		...
		EXCEPTION_THROW(CommonException,"$GETSYI failed")
