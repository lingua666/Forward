...
#ifndef __NALU265_20171226154204_3344199361_H__
#define __NALU265_20171226154204_3344199361_H__
...
struct tagNALU265_HEADER
{
	unsigned char lLayerID : 1;
	unsigned char TYPE	: 6;
	unsigned char F		: 1;
	unsigned char TID : 3;
	unsigned char hLayerID : 5;
}; /* 1 BYTES */

struct tagFU265_A_HEADER
{
	tagNALU265_HEADER	Indicator;//NaluH;
	unsigned char	TYPE: 6;	//内容同NaluH成员TYPE
...
{
public:
	static UInt8 Get_Type( const char* c_szData, UInt32 uLen );
...
public:
	...
	int GetSPS( h265_sps_t* pSPS );

	int GetPPS( h265_pps_t* pPPS );

	bool isSlice( void );

	videoinfo_t* GetVideoInfo( void )
	{
		return &_VedioInfo;
	}
...
protected:
	...
	void h265_read_sps_rbsp(h265_sps_t* h, bs_t* b);

	void h265_read_pps_rbsp(h265_pps_t* h, bs_t* b);
