...
template< class T = void> struct vector0 { enum{ value = 0 }; typedef vector_tag<0> tag; typedef v_iter<vector0<>, boost::mpl::int_<0> > begin; };
template< class P0 > struct vector1 { enum{ value = 1 }; typedef vector_tag<1> tag; typedef v_iter<vector1< P0>, boost::mpl::int_<0> > begin; typedef P0 item0; };
template< class P0 , class P1 > struct vector2 { enum{ value = 2 }; typedef vector_tag<2> tag; typedef v_iter<vector2< P0 , P1>, boost::mpl::int_<0> > begin; typedef P0 item0; typedef P1 item1; };
template< class P0 , class P1 , class P2 > struct vector3 { enum{ value = 3 }; typedef vector_tag<3> tag; typedef v_iter<vector3< P0 , P1 , P2>, boost::mpl::int_<0> > begin; typedef P0 item0; typedef P1 item1; typedef P2 item2; };
template< class P0 , class P1 , class P2 , class P3 > struct vector4 { enum{ value = 4 }; typedef vector_tag<4> tag; typedef v_iter<vector4< P0 , P1 , P2 , P3>, boost::mpl::int_<0> > begin; typedef P0 item0; typedef P1 item1; typedef P2 item2; typedef P3 item3; };
template< class P0 , class P1 , class P2 , class P3 , class P4 > struct vector5 { enum{ value = 5 }; typedef vector_tag<5> tag; typedef v_iter<vector5< P0 , P1 , P2 , P3 , P4>, boost::mpl::int_<0> > begin; typedef P0 item0; typedef P1 item1; typedef P2 item2; typedef P3 item3; typedef P4 item4; };
template< class P0 , class P1 , class P2 , class P3 , class P4 , class P5 > struct vector6 { enum{ value = 6 }; typedef vector_tag<6> tag; typedef v_iter<vector6< P0 , P1 , P2 , P3 , P4 , P5>, boost::mpl::int_<0> > begin; typedef P0 item0; typedef P1 item1; typedef P2 item2; typedef P3 item3; typedef P4 item4; typedef P5 item5; };
