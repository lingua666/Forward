...
#ifndef  __CUSTOM_UUID_HEAD_DEF__
#define  __CUSTOM_UUID_HEAD_DEF__
...
public:
	...
	explicit UUID(const _string_type& uuid);
	...
	void parse(const _string_type& uuid);
		/// Parses the UUID from its string representation.

	_string_type toString() const;
...
protected:
	...
	static void appendHex(_string_type& str, UInt8 n);
	static void appendHex(_string_type& str, UInt16 n);
	static void appendHex(_string_type& str, UInt32 n);
...
#endif // __CUSTOM_UUID_HEAD_DEF__
