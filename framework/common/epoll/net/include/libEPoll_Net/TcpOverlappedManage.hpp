...
#ifndef __TCP_OVERLAPPEDMANAGE_20151202110154_1449025314_H__
#define __TCP_OVERLAPPEDMANAGE_20151202110154_1449025314_H__
...
#include "External.h"
	...
	namespace _epoll_net_{
		...
		namespace _tcp_{
			...
			typedef	function_v20<int (SOCKET, char*, unsigned long)> HFNPerform;
