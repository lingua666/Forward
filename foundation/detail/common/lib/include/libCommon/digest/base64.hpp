...
#ifndef __BASE64_HPP_20150806193305_1438860785_H__
#define __BASE64_HPP_20150806193305_1438860785_H__
...
inline std::string base64_decode(unsigned char const * input, size_t len) {
	size_t in_len = len;
	int i = 0;
	int j = 0;
	int in_ = 0;
