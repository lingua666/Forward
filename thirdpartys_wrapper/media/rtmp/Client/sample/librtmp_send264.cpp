...
{  
	...
	/*连接流*/
	printf("RTMP_ConnectStream begin\r\n");
...
{    
	...
	//test
	char szData[1024] = { 0 };
	memcpy(szData, naluUnit.data, naluUnit.size);
	//test
	...
	//test
	memcpy(szData, metaData.Sps, metaData.nSpsLen);
	//test
