...
typedef enum {
	...
	/*ASR Recorder*/
	HCI_ERR_RECORDER_NOT_INIT = 1200,				///< 1200: ASR Recorder未初始化
	HCI_ERR_RECORDER_ALREADY_INIT,					///< 1201: ASR Recorder已经初始化
	HCI_ERR_RECORDER_NOT_BEGIN,						///< 1202: ASR Recorder未开始录音
	HCI_ERR_RECORDER_ALREADY_BEGIN					///< 1203: ASR Recorder已经开始录音
