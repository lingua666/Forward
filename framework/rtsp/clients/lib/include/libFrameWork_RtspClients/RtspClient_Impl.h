...
#ifndef __RTSPCLIENT_IMPL_20180104162504_3344199361_H__
#define __RTSPCLIENT_IMPL_20180104162504_3344199361_H__
...
{
	RTSP_ERRCODE_NULL,
	RTSP_ERRCODE_CONNECT_FAILED = 1,
	RTSP_ERRCODE_CONNECT_CLOSE,
	RTSP_ERRCODE_DESCRIBE_ACK_FAILED,
	RTSP_ERRCODE_SETUP_ACK_FAILED,
	RTSP_ERRCODE_PLAY_ACK_FAILED,
	RTSP_ERRCODE_OPEN_RTP_FAILED,
	RTSP_ERRCODE_OPEN_RTCP_FAILED,
	RTSP_ERRCODE_RTP_TIMEOUT,
	RTSP_ERRCODE_EXCEPT_CLOSE
};

#define RTP_MAX_BUF		(409600)

class RtspClient_Impl : public _enable_shared_from_this<RtspClient_Impl>
{
public:
#pragma pack(push, 1)
...
#pragma pack(pop)
	...
	typedef function20_handle<void (const char*, const char*, UInt32)>	HFNRtpDataNT;
...
public:
	...
	RtspClient_Impl::tagRtspCtrlInfo& GetRtspCtrlInfo( void );
	...
	_string_type GetMediaVideoHeadBuffer( void );
