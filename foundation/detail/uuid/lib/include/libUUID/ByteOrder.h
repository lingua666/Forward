...
#ifndef  __CUSTOM_BYTEORDER_HEAD_DEF__
#define  __CUSTOM_BYTEORDER_HEAD_DEF__
...
#if defined(PLATFORM_ARCH_BIG_ENDIAN)
...
#endif // __CUSTOM_BYTEORDER_HEAD_DEF__
