#ifndef  __CUSTOMS_CHEART_HEADER_DEF__
#define __CUSTOMS_CHEART_HEADER_DEF__
...
#define	HEART_INTERVAL_TIME	30000		//单位毫秒
#define	HEART_RESEND_TIME	3			//
	...
	protected:
		static void	Send( const CmdSession_sptr& Session_ptr )
		{
			...
			Session_ptr->Send(&Hdr, reinterpret_cast<char*>(&UtcTime), sizeof(UtcTime));
		}
