...
typedef _string_v20_::string	string_type;
...
int main(int argc, char* argv[])
{
	...
	_string_type::NumberToStr(10000);// == 100
...

	{
		...
		for(int i = 0; i < num; i ++)
		{
			_string_type::StringToInt(s);// == 100;
		}
		printf("_string_type11 time:%d\r\n", (_timestamp_::Timestamp().epochMicroseconds() - time.epochMicroseconds()) / 1000);
	}
