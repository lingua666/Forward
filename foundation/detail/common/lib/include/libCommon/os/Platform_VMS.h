...
// Platform_VMS.h
//
// $Id: //poco/1.3/Foundation/include/Poco/Platform_VMS.h#1 $
//
// Library: Foundation
// Package: Core
// Module:  Platform
...
#ifndef __PLATFORM_VMS_20151127152350_1448609030_H__
#define __PLATFORM_VMS_20151127152350_1448609030_H__
...
// Our macros work with both 32bit and 64bit pointer sizes.
	...
	#define PLATFORM_DESCRIPTOR_STRING(name, string) \
	...
	#define PLATFORM_DESCRIPTOR_LITERAL(name, string) \
		struct dsc$descriptor_s name =	\
		{								\
			sizeof(string) - 1,			\
			DSC$K_DTYPE_T,				\
...
#define PLATFORM_NO_SYS_SELECT_H


#endif // __CUSTOM_PLATFORM_VMS_HEAD_DEF__
