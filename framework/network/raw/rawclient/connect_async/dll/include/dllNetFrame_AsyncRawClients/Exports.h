...
/*返回值：	
*****************************************************************/
typedef void (_CALLTYPE *fpnMRaw_C_Connect)( const char* c_szSvrIP,
											UInt16 uSvrPort,
											NETHANDLE handle );
...
/*返回值：	
*****************************************************************/
typedef void (_CALLTYPE *fpnMRaw_C_Close)( const char* c_szIP,
											UInt16 uPort,
											NETHANDLE handle );
...
/*返回值：		64bit连接句柄
*****************************************************************/
typedef void (_CALLTYPE *fpnMRaw_C_RecData)( NETHANDLE handle,
											const char* c_szData,
											UInt32 u32Size );
