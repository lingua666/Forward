...
#ifndef __SOCKSTREAM_20150721142643_1437460003_H__
#define __SOCKSTREAM_20150721142643_1437460003_H__

#include <libNetFrame_Core/Socket.h>
#include <libNetFrame_Core/ISockStream.h>
...
namespace _io_net_{
	...
	namespace _tcp_{
		...
		*/
		...
		class SockStream : public _enable_shared_from_this<SockStream>//public boost::enable_shared_from_this<SockStream>
		{
		public:
		...
		public:
			...
			int	SendData( const char* c_szData, UInt32 u32Size );

	#ifdef USE_BOOST_ASIO
			int	PostRecv( void );

			void	PostSend( const char* c_szData, UInt32 u32Size );
	#else
			...
			EVENT_PERMISSION_LIST_BEGIN()
				...
				PERMISSION_WRITE(const STREAM_HANDLE&, const char*, UInt32)
				PERMISSION_PREPARE_WRITE(const STREAM_HANDLE&, const char*, UInt32)
