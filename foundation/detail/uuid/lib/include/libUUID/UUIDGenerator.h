...
#ifndef  __CUSTOM_UUIDGENERATOR_HEAD_DEF__
#define  __CUSTOM_UUIDGENERATOR_HEAD_DEF__


#include <libUUID/UUID.h>
#include <libUUID/Random.h>
...
public:
	...
	UUID createFromName(const UUID& nsid, const _string_type& name);
		/// Creates a name-based UUID.

	UUID createFromName(const UUID& nsid, const _string_type& name, DigestEngine& de);
	...
	static _string_type	UUIDToString( void );

	static _string_type	UUIDHexToString( void );
		
protected:
	Timestamp_type::UtcTimeVal timeStamp();
	void getNode();

private:
	CLock				_Lock;
	Random              _random;
	Timestamp_type      _lastTime;
	int                 _ticks;
...
#endif // __CUSTOM_UUIDGENERATOR_HEAD_DEF__
